...
Gradient bluegreen = LinearGradient(
    begin: Alignment.topRight,
    end: Alignment.bottomLeft,
    colors: [
...
List<Map> indoor = [
  {'name': 'Practice Training', 'iconPath': 'images/cat.png'},
  {'name': 'Tug-of-War', 'iconPath': 'images/dog.png'},
  {'name': 'Indoor Fetch', 'iconPath': 'images/rabbit.png'},
  {'name': 'Toys', 'iconPath': 'images/parrot.png'},
  {'name': 'Find the Treats', 'iconPath': 'images/horse.png'},
];
List<Map> outdoor = [
  {'name': 'Fetch', 'iconPath': 'images/cat.png'},
  {'name': 'Walking', 'iconPath': 'images/dog.png'},
  {'name': 'Dog Park', 'iconPath': 'images/rabbit.png'},
  {'name': 'Jogging', 'iconPath': 'images/parrot.png'},
  {'name': 'Hiking', 'iconPath': 'images/horse.png'},
  {'name': 'Biking', 'iconPath': 'images/horse.png'},
  {'name': 'Camping', 'iconPath': 'images/horse.png'}
];
...
var dogtraining = "hello Sit amet risus nullam eget. Viverra adipiscing at in tellus integer feugiat Consectetur adipiscing elit duis tristique sollicitudin nibh. Dictumst quisque sagittis purus sit ameConsectetur adipiscing elit duis tristique sollicitudin nibh. Dictumst quisque sagittis purus sit amet volutpat. Quis enim lobortis scelerisque fermentum dui faucibus in ornare. Pellentesque diam volutpat commodo sed egestas egestas fringilla phasellus. Mauris pharetra et ultrices neque. Leo duis ut diam quam nulla porttitor. Sit amet facilisis magna etiam tempor orci eu lobortis elementum. Blandit massa enim nec dui. Aliquam id diam maecenas ultricies mi eget mauris. Mattis rhoncus urna neque viverra justo nec ultrices. Nibh tellus molestie nunc non blandit. Non diam phasellus vestibulum lorem. Ut diam quam nulla porttitor massa id neque aliquam. Eget mauris pharetra et ultrices neque ornare aenean euismod. Urna id volutpat lacus laoreet non curabitur gravida arcu ac. Tellus in hac habitasse platea dictumst vestibulum.";
